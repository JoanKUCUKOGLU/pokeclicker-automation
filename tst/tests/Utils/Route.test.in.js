...
describe(`${AutomationTestUtils.categoryPrefix}Check findBestRouteForFarmingType() method`, () => {
  test("Low click attack", () => {
    ...
    let result = Automation.Utils.Route.findBestRouteForFarmingType(
  ...
  let testCases = [
    ...
    },
    {
      ...
      expectedRoute: [0, 22],
      expectedHigherRoute: [1, 34],
    },
    {
      testDesc: "Best for Bug type",
      type: PokemonType.Bug,
      expectedRoute: [0, 2],
      expectedHigherRoute: [1, 30],
    },
    {
      testDesc: "Best for Rock type",
      type: PokemonType.Rock,
      expectedRoute: [1, 46],
      expectedHigherRoute: [1, 46],
    },
    {
