...
Automation.Utils.Battle.calculateClickAttack = function () {
...
describe(`${AutomationTestUtils.categoryPrefix}Check findBestGymForFarmingType() method`, () => {
  test("Low click attack", () => {
    ...
    let result = Automation.Utils.Gym.findBestGymForFarmingType(
  ...
  let testCases = [
    {
      testDesc: "Best for Normal type",
      type: PokemonType.Normal,
      expectedGym: "Violet City",
      expectedHigherGym: "Violet City",
    },
    {
      testDesc: "Best for Fire type",
      type: PokemonType.Fire,
      expectedGym: "Cinnabar Island",
      expectedHigherGym: "Cinnabar Island",
    },
    {
      testDesc: "Best for Water type",
      type: PokemonType.Water,
      expectedGym: "Cerulean City",
      expectedHigherGym: "Cerulean City",
    },
    {
      testDesc: "Best for Electric type",
      type: PokemonType.Electric,
      expectedGym: "Vermilion City",
      expectedHigherGym: "Vermilion City",
    },
    {
      testDesc: "Best for Grass type",
      type: PokemonType.Grass,
      expectedGym: "Celadon City",
      expectedHigherGym: "Celadon City",
    },
    {
      testDesc: "Best for Ice type",
      type: PokemonType.Ice,
      expectedGym: "Elite Lorelei",
      expectedHigherGym: "Elite Lorelei",
    },
    {
      testDesc: "Best for Fighting type",
      type: PokemonType.Fighting,
      expectedGym: "Elite Bruno",
      expectedHigherGym: "Cianwood City",
    },
    {
      testDesc: "Best for Poison type",
      type: PokemonType.Poison,
      expectedGym: "Fuchsia City",
      expectedHigherGym: "Ecruteak City",
    },
    {
      testDesc: "Best for Ground type",
      type: PokemonType.Ground,
      expectedGym: "Pewter City",
      expectedHigherGym: "Viridian City",
    },
    {
      testDesc: "Best for Flying type",
      type: PokemonType.Flying,
      expectedGym: "Elite Lance",
      expectedHigherGym: "Champion Lance",
    },
    {
      testDesc: "Best for Psychic type",
      type: PokemonType.Psychic,
      expectedGym: "Cerulean City",
      expectedHigherGym: "Elite Will",
    },
    {
      testDesc: "Best for Bug type",
      type: PokemonType.Bug,
      expectedGym: "Azalea Town",
      expectedHigherGym: "Azalea Town",
    },
    {
      testDesc: "Best for Rock type",
      type: PokemonType.Rock,
      expectedGym: "Pewter City",
      expectedHigherGym: "Pewter City",
    },
    {
      testDesc: "Best for Ghost type",
      type: PokemonType.Ghost,
      expectedGym: "Elite Agatha",
      expectedHigherGym: "Ecruteak City",
    },
    {
      testDesc: "Best for Dragon type",
      type: PokemonType.Dragon,
      expectedGym: "Elite Lance",
      expectedHigherGym: "Blackthorn City",
    },
    {
      testDesc: "Best for Dark type",
      type: PokemonType.Dark,
      expectedGym: "Elite Karen",
      expectedHigherGym: "Elite Karen",
    },
    {
      testDesc: "Best for Steel type",
      type: PokemonType.Steel,
      expectedGym: "Olivine City",
      expectedHigherGym: "Olivine City",
    },
    {
      testDesc: "Best for Fairy type",
      type: PokemonType.Fairy,
      expectedGym: "Saffron City",
      expectedHigherGym: "Goldenrod City",
    },
  ];
