...
Automation.Farm.__internal__contentFloatingContainer =
  __test__stubs__getHTMLElementStub();
Automation.Farm.__internal__contentFloatingContentContainer =
  __test__stubs__getHTMLElementStub();
...
function runPlotUnlockTest(slotToBeUnlocked) {
  expect(Automation.Farm.__internal__currentStrategy.harvestStrategy).toBe(
    Automation.Farm.__internal__harvestTimingType.AsSoonAsPossible
  );
  ...
  App.game.wallet.__currencies[GameConstants.Currency.farmPoint] =
    unlockFPAmount - 1;
  ...
  expect(App.game.wallet.__currencies[GameConstants.Currency.farmPoint]).toBe(
    0
  );
}

function runBerryMutationTest(
  targetBerry,
  expectedConfig,
  expectedOrder,
  ...
  expect(Automation.Farm.__internal__currentStrategy.berryToUnlock).toBe(
    targetBerry
  );
  expect(Automation.Farm.__internal__currentStrategy.harvestStrategy).toBe(
    Automation.Farm.__internal__harvestTimingType.RightBeforeWithering
  );
  ...
  App.game.farming.plotList[8].age =
    targetBerryData.growthTime[PlotStage.Bloom] + 1;
  Automation.Farm.__internal__farmLoop();
...
function checkMutationLayoutRotation(expectedConfig, expectedOrder) {
  const currentMutationBerry =
    Automation.Farm.__internal__currentStrategy.berryToUnlock;
  ...
  const targetAge =
    App.game.farming.berryData[expectedOrder[0]].growthTime[PlotStage.Bloom];
  const agingPlot =
    App.game.farming.plotList[expectedConfig[expectedOrder[0]][0]];
  for (const index of expectedOrder.keys()) {
    ...
    const nextBerryGrowingTime =
      App.game.farming.berryData[expectedOrder[index + 1]].growthTime[
        PlotStage.Bloom
      ];
...
function runBerryMutationTestNoTiming(
  targetBerry,
...
function checkItemNeededBehaviour(oakItemNeeded) {
  ...
  expect(Automation.Farm.__internal__currentStrategy.oakItemToEquip).toBe(
    oakItemNeeded
  );
...
function checkPokemonNeededBehaviour(pokemonName) {
  ...
  expect(Automation.Farm.__internal__currentStrategy.requiredPokemon).toBe(
    pokemonName
  );
}
...
function expectFocusOnUnlocksToBeDisabled(reenableConditionCallback) {
  ...
  expect(
    Automation.Menu.__disabledElements.has(
      Automation.Farm.Settings.FocusOnUnlocks
    )
  ).toBe(true);
...
beforeAll(() => {
  ...
  Automation.Utils.LocalStorage.setValue(
    Automation.Farm.Settings.SelectedBerryToPlant,
    BerryType.Cheri
  );
  ...
  // Simulate Unlock setting being enabled by default (done in the Automation.InitSteps.BuildMenu)
  Automation.Utils.LocalStorage.setValue(
    Automation.Farm.Settings.OakItemLoadoutUpdate,
    true
  );
  expect(
    Automation.Utils.LocalStorage.getValue(
...
test("Not enough berry to unlock anything", () => {
  ...
  expect(Automation.Farm.__internal__currentStrategy).toBe(
    Automation.Farm.__internal__unlockStrategySelection[0]
  );
  ...
  expect(App.game.farming.__berryListCount[BerryType.Cheri]).toBe(
    initialCheriCount - 1
  );
  ...
  App.game.farming.plotList[12].age =
    cheriData.growthTime[PlotStage.Sprout] + 1;
  Automation.Farm.__internal__farmLoop();
  ...
  App.game.farming.plotList[12].age =
    cheriData.growthTime[PlotStage.Taller] + 1;
  Automation.Farm.__internal__farmLoop();
...
describe(`${AutomationTestUtils.categoryPrefix}Gen 1 unlocks`, () => {
  ...
  test("Unlock plot 13", () => {
    ...
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[1]
    );
  ...
  test("Unlock plot 17", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[2]
    );
  ...
  test("Unlock plot 11", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[3]
    );
  ...
  test("Unlock plot 6", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[4]
    );
  ...
  test("Unlock plot 8", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[5]
    );
  ...
  test("Unlock plot 18", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[6]
    );
  ...
  test("Unlock plot 16", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[7]
    );
  ...
  test("Gen 1 berry gathering", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[8]
    );
    ...
    for (const index of [6, 7, 8, 11, 12, 13, 16, 17, 18]) {
      const berryData =
        App.game.farming.berryData[App.game.farming.plotList[index].berry];
      App.game.farming.plotList[index].age =
        berryData.growthTime[PlotStage.Bloom] + 1;
    }
    Automation.Farm.__internal__farmLoop();

    // Expect the strategy to be pointing to the next one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[9]
    );
  });
});
...
describe(`${AutomationTestUtils.categoryPrefix}Gen 2 unlocks`, () => {
  ...
  test("Unlock plot 2", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[10]
    );
  ...
  test("Unlock Razz berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[11]
    );
  ...
  test("Unlock plot 14", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[12]
    );
  ...
  test("Unlock Bluk berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[13]
    );
  ...
  test("Unlock plot 22", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[14]
    );
  ...
  test("Unlock Nanab berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[15]
    );
  ...
  test("Unlock plot 10", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[16]
    );
  ...
  test("Unlock Wepear berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[17]
    );
  ...
  test("Unlock plot 3", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[18]
    );
  ...
  test("Unlock Pinap berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[19]
    );
  ...
  test("Unlock plot 19", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[20]
    );
  ...
  test("Unlock Figy berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[21]
    );
  ...
  test("Unlock plot 21", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[22]
    );
  ...
  test("Unlock Wiki berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[23]
    );
  ...
  test("Unlock plot 5", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[24]
    );
  ...
  test("Unlock Mago berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[25]
    );
  ...
  test("Unlock plot 1", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[26]
    );
  ...
  test("Unlock Aguav berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[27]
    );
  ...
  test("Unlock plot 9", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[28]
    );
  ...
  test("Unlock Iapapa berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[29]
    );
  ...
  test("Unlock plot 23", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[30]
    );
  ...
  test("Gen 2 berry gathering", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[31]
    );
    ...
    // Expect the strategy to be pointing to the next one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[32]
    );
  });
});
...
describe(`${AutomationTestUtils.categoryPrefix}Gen 3 unlocks`, () => {
  ...
  test("Unlock plot 15", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[33]
    );
  ...
  test("Unlock Kelpsy berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[34]
    );
  ...
  test("Unlock plot 0", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[35]
    );
  ...
  test("Unlock Qualot berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[36]
    );
  ...
  test("Unlock plot 4", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[37]
    );
  ...
  test("Unlock Hondew berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[38]
    );
  ...
  test("Unlock plot 24", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[39]
    );
  ...
  test("Unlock Grepa berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[40]
    );
  ...
  test("Unlock plot 20", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[41]
    );
  ...
  test("Unlock Tamato berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[42]
    );
    ...
    expectedConfig[BerryType.Razz] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => !expectedConfig[BerryType.Pomeg].includes(x));
  ...
  test("Unlock Cornn berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[43]
    );
  ...
  test("Unlock Magost berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[44]
    );
  ...
  test("Unlock Rabuta berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[45]
    );
    ...
    expectedConfig[BerryType.Aspear] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => !expectedConfig[BerryType.Aguav].includes(x));
  ...
  test("Unlock Nomel berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[46]
    );
  ...
  test("Gen 3 next steps needed berry gathering", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[47]
    );
    ...
    // Expect the strategy to be pointing to the next one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[48]
    );
  });
  ...
  test("Unlock Spelon berry", () => {
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Tamato] = App.game.farming.plotList.map(
      (_, index) => index
    );
  ...
  test("Unlock Pamtre berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[49]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Cornn] = App.game.farming.plotList.map(
      (_, index) => index
    );
  ...
  test("Unlock Watmel berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[50]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Magost] = App.game.farming.plotList.map(
      (_, index) => index
    );
  ...
  test("Unlock Durin berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[51]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Rabuta] = App.game.farming.plotList.map(
      (_, index) => index
    );
  ...
  test("Unlock Belue berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[52]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Nomel] = App.game.farming.plotList.map(
      (_, index) => index
    );
  ...
  test("Unlock Pinkan berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[53]
    );
  ...
  test("Gen 3 berry gathering", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[54]
    );
    ...
    // Expect the strategy to be pointing to the next one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[55]
    );
  });
});
...
describe(`${AutomationTestUtils.categoryPrefix}Gen 4 unlocks`, () => {
  ...
  test("Unlock Occa berry", () => {
    ...
    runBerryMutationTest(BerryType.Occa, expectedConfig, expectedOrder, null, [
  ...
  test("Unlock Coba berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[56]
    );
  ...
  test("Unlock Passho berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[57]
    );
  ...
  test("Unlock Wacan berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[58]
    );
  ...
  test("Unlock Rindo berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[59]
    );
  ...
  test("Unlock Yache berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[60]
    );
  ...
  test("Unlock Payapa berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[61]
    );
  ...
  test("Unlock Tanga berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[62]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Rindo] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![6, 8, 16, 18].includes(x));
  ...
  test("Unlock Kasib berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[63]
    );
    ...
    expect(Automation.Farm.__internal__currentStrategy.harvestStrategy).toBe(
      Automation.Farm.__internal__harvestTimingType.LetTheBerryDie
    );
    ...
    // Check the forbidden Oak items
    expect(
      Automation.Farm.__internal__currentStrategy.forbiddenOakItems
    ).toEqual([]);
    expect(Automation.Utils.OakItem.ForbiddenItems).toEqual([]);
  ...
  test("Unlock Haban berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[64]
    );
  ...
  test("Unlock Colbur berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[65]
    );
  ...
  test("Unlock Roseli berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[66]
    );
  ...
  test("Unlock Shuca berry", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[67]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Watmel] = App.game.farming.plotList.map(
      (_, index) => index
    );
  ...
  test("Unlock Charti berry", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[68]
    );
  ...
  test("Unlock Babiri berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[69]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Shuca] = [
      0, 1, 2, 3, 4, 7, 17, 20, 21, 22, 23, 24,
    ];
  ...
  test("Unlock Snover berry", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[70]
    );
    ...
    // |a|a| | | |
    const expectedConfig = {};
    expectedConfig[BerryType.Babiri] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![18, 19, 22, 23, 24].includes(x));
  ...
  test("Unlock Chople berry", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[71]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Spelon] = App.game.farming.plotList.map(
      (_, index) => index
    );
  ...
  test("Wait for plots to be emptied", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[72]
    );
    ...
    // Expect the strategy to be pointing to the next one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[73]
    );
  });
  ...
  test("Unlock Chilan berry > step 1", () => {
    ...
    for (const index of [6, 8, 16, 18]) {
      App.game.farming.plotList[index].age =
        chopleBerryData.growthTime[PlotStage.Bloom];
    }
    Automation.Farm.__internal__farmLoop();
    runBerryMutationTestNoTiming(BerryType.Chilan, chilanUnlockFirstStep, true);
    ...
    for (const index of [6, 8, 16, 18]) {
      App.game.farming.plotList[index].age =
        chopleBerryData.growthTime[PlotStage.Bloom] + 1;
    }
    Automation.Farm.__internal__farmLoop();
  });
  ...
  test("Unlock Kebia berry", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[74]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Pamtre] = App.game.farming.plotList.map(
      (_, index) => index
    );
...
describe(`${AutomationTestUtils.categoryPrefix}Gen 5 unlocks`, () => {
  ...
  test("Unlock Micle berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[75]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Pamtre] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![6, 8, 11, 12, 13].includes(x));
    const expectedOrder = [BerryType.Pamtre];
    runBerryMutationTest(BerryType.Micle, expectedConfig, expectedOrder, null, [
  ...
  test("Unlock Custap berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[76]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Watmel] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![6, 8, 11, 12, 13].includes(x));
    const expectedOrder = [BerryType.Watmel];
    runBerryMutationTest(
  ...
  test("Unlock Jaboca berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[77]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Durin] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![6, 8, 11, 12, 13].includes(x));
  ...
  test("Unlock Rowap berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[78]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Belue] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![6, 8, 11, 12, 13].includes(x));
  ...
  test("Unlock Liechi berry", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[79]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Passho] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![12, 13].includes(x));
    const expectedOrder = [BerryType.Passho];
  ...
  test("Farm 4 Liechi berries", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[80]
    );
  ...
  test("Unlock Ganlon berry", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[81]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Shuca] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![12, 13].includes(x));
  ...
  test("Farm 4 Ganlon berries", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[82]
    );
  ...
  test("Unlock Kee berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[83]
    );
  ...
  test("Unlock Salac berry", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[84]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Coba] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![12, 13].includes(x));
  ...
  test("Farm 4 Salac berries", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[85]
    );
  ...
  test("Unlock Petaya berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[86]
    );
  ...
  test("Farm 4 Petaya berries", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[87]
    );
  ...
  test("Unlock Maranga berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[88]
    );
  ...
  test("Unlock Apicot berry", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[89]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Chilan] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![12, 13].includes(x));
  ...
  test("Unlock Lansat berry", () => {
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[90]
    );
    ...
    // |a|a|a|a|a|
    const expectedConfig = {};
    expectedConfig[BerryType.Roseli] = App.game.farming.plotList
      .map((_, index) => index)
      .filter((x) => ![12, 13].includes(x));
  ...
  test("Unlock Starf berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[91]
    );
...
describe(`${AutomationTestUtils.categoryPrefix}Bonus berries`, () => {
  ...
  test("Unlock Lum berry", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[92]
    );
  ...
  test("Farm 24 Lum berries", () => {
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[93]
    );
  ...
  test("Unlock Enigma berry", () => {
    expectFocusOnUnlocksToBeDisabled(function () {
      ...
      const enigmaMutation = App.game.farming.mutations.filter(
        (mutation) => mutation instanceof EnigmaMutation
      )[0];
    ...
    // Expect the strategy to be pointing to the right one
    expect(Automation.Farm.__internal__currentStrategy).toBe(
      Automation.Farm.__internal__unlockStrategySelection[94]
    );

    // Check the stategy needed pokemon
    expect(Automation.Farm.__internal__currentStrategy.requiresDiscord).toBe(
      true
    );
...
describe(`${AutomationTestUtils.categoryPrefix}Mutation strategy with occupied plot`, () => {
  test("Berries on strategy empty slots > Bloom time higher than the strategy one", () => {
    ...
    App.game.farming.plotList[12].age =
      App.game.farming.berryData[BerryType.Micle].growthTime[PlotStage.Bloom] -
  ...
  test("Berries on strategy empty slots > Bloom time lower than the strategy one", () => {
    ...
    const occaBloomTime =
      App.game.farming.berryData[BerryType.Occa].growthTime[PlotStage.Bloom];
    let ageDiff =
      App.game.farming.berryData[BerryType.Rindo].growthTime[PlotStage.Bloom] -
      occaBloomTime;
    ...
    // Simulate the berries aging
    const passhoBloomTime =
      App.game.farming.berryData[BerryType.Passho].growthTime[PlotStage.Bloom];
    ...
    ageDiff =
      passhoBloomTime -
      App.game.farming.berryData[BerryType.Wacan].growthTime[PlotStage.Bloom];
    simulateTimePassing(ageDiff);
    ...
    // Simulate the berries aging
    ageDiff =
      App.game.farming.berryData[BerryType.Custap].growthTime[PlotStage.Bloom] -
      App.game.farming.plotList[12].age;
    simulateTimePassing(ageDiff + 1);
  ...
  test("Berries on strategy needed slot > Bloom time higher than the strategy one", () => {
    ...
    App.game.farming.plotList[7].age =
      App.game.farming.berryData[BerryType.Micle].growthTime[PlotStage.Bloom] +
      1;
  ...
  test("Berries on strategy needed slot > Berries on all strategy berry type slots", () => {
    ...
    const rindoTime =
      App.game.farming.berryData[BerryType.Rindo].growthTime[PlotStage.Bloom];
    const liechiDiffTime =
      App.game.farming.berryData[BerryType.Liechi].growthTime[PlotStage.Bloom] -
      rindoTime;
    App.game.farming.plotList[0].age =
      liechiDiffTime +
      App.game.farming.berryData[BerryType.Occa].growthTime[PlotStage.Bloom];
    App.game.farming.plotList[2].age =
      liechiDiffTime +
      App.game.farming.berryData[BerryType.Passho].growthTime[PlotStage.Bloom];
    App.game.farming.plotList[5].age =
      liechiDiffTime +
      App.game.farming.berryData[BerryType.Wacan].growthTime[PlotStage.Bloom];
...
describe(`${AutomationTestUtils.categoryPrefix}Edge cases`, () => {
  ...
  test("Trying to unlock a berry needing an Oak item without the option enabled", () => {
    ...
    const expectedReasonStart =
      "The next unlock requires the 'Sprinklotad' Oak item";
    expect(
      Automation.Menu.__disabledElements
        .get(Automation.Farm.Settings.FocusOnUnlocks)
        .startsWith(expectedReasonStart)
    ).toBe(true);
  ...
  test("Skipping Pinkan berry if not unlocked", () => {
    ...
    const pinkanBerryData = App.game.farming.mutations.find(
      (mutation) => mutation.mutatedBerry == BerryType.Pinkan
    );
  ...
  test("Remove items that are forbidden", () => {
    ...
    expect(App.game.oakItems.itemList[OakItemType.Rocky_Helmet].isActive).toBe(
      false
    );
    expect(App.game.oakItems.itemList[OakItemType.Cell_Battery].isActive).toBe(
      false
    );
