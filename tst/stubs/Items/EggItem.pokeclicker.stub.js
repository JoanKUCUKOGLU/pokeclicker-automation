...
class EggItem extends Item {
  // instead of : CaughtIndicatingItem
  /***************************\
  ...
  getCaughtStatus() {
    ...
    switch (this.type) {
      ...
      default: {
        const eggType =
          EggType[GameConstants.EggItemType[this.type].split("_")[0]];
  ...
  use() {
    ...
    if (this.type === GameConstants.EggItemType.Pokemon_egg) {
      success = App.game.breeding.gainPokemonEgg(
        pokemonMap.randomRegion(player.highestRegion())
      );
      ...
      const eggType =
        EggType[GameConstants.EggItemType[this.type].split("_")[0]];
      success = App.game.breeding.gainEgg(
        App.game.breeding.createTypedEgg(eggType)
      );
    }
...
ItemList.Fire_egg = new EggItem(
  GameConstants.EggItemType.Fire_egg,
  1000,
  undefined,
  "Fire Egg"
);
ItemList.Water_egg = new EggItem(
  GameConstants.EggItemType.Water_egg,
  1000,
  undefined,
  "Water Egg"
);
ItemList.Grass_egg = new EggItem(
  GameConstants.EggItemType.Grass_egg,
  1000,
  undefined,
  "Grass Egg"
);
ItemList.Fighting_egg = new EggItem(
  GameConstants.EggItemType.Fighting_egg,
  1000,
  undefined,
  "Fighting Egg"
);
ItemList.Electric_egg = new EggItem(
  GameConstants.EggItemType.Electric_egg,
  1000,
  undefined,
  "Electric Egg"
);
ItemList.Dragon_egg = new EggItem(
  GameConstants.EggItemType.Dragon_egg,
  1000,
  undefined,
  "Dragon Egg"
);
ItemList.Pokemon_egg = new EggItem(
  GameConstants.EggItemType.Pokemon_egg,
  1000,
  undefined,
  "Pokémon Egg"
);
ItemList.Mystery_egg = new EggItem(
