...
UndergroundItems.addItem(
  new UndergroundItem(211, "Fossilized_bird", UndergroundItemValueType.Fossil)
);
UndergroundItems.addItem(
  new UndergroundItem(212, "Fossilized_fish", UndergroundItemValueType.Fossil)
);
UndergroundItems.addItem(
  new UndergroundItem(213, "Fossilized_drake", UndergroundItemValueType.Fossil)
);
UndergroundItems.addItem(
  new UndergroundItem(214, "Fossilized_dino", UndergroundItemValueType.Fossil)
);
