...
class TypeHelper {
  static getAttackModifier(
    ...
    if (
      attackerType1 === PokemonType.None ||
      defenderType1 === PokemonType.None
    ) {
      return 1;
    }
    ...
    attackerType2 =
      attackerType2 !== PokemonType.None ? attackerType2 : attackerType1;
    defenderType2 =
      defenderType2 !== PokemonType.None ? defenderType2 : defenderType1;
    ...
    if (!App.game.challenges.list.disableGems.active()) {
      m1 +=
        App.game.gems.getGemUpgrade(attackerType1, this.valueToType(m1)) *
        GameConstants.GEM_UPGRADE_STEP;
      m2 +=
        App.game.gems.getGemUpgrade(attackerType1, this.valueToType(m2)) *
        GameConstants.GEM_UPGRADE_STEP;
      m3 +=
        App.game.gems.getGemUpgrade(attackerType2, this.valueToType(m3)) *
        GameConstants.GEM_UPGRADE_STEP;
      m4 +=
        App.game.gems.getGemUpgrade(attackerType2, this.valueToType(m4)) *
        GameConstants.GEM_UPGRADE_STEP;
    }
