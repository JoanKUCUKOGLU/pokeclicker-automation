...
class OakItems {
  ...
  activate(oakItem) {
    ...
    if (
      ...
      this.itemList.reduce(
        (count, item) => count + (item.isActive ? 1 : 0),
        0
      ) < this.maxActiveCount()
    ) {
      item.isActive = true;
  ...
  __initItemList() {
    this.itemList[OakItemType.Magic_Ball] = new OakItem(
      OakItemType.Magic_Ball,
      "Magic Ball"
    );
    this.itemList[OakItemType.Amulet_Coin] = new OakItem(
      OakItemType.Amulet_Coin,
      "Amulet Coin"
    );
    this.itemList[OakItemType.Rocky_Helmet] = new OakItem(
      OakItemType.Rocky_Helmet,
      "Rocky Helmet"
    );
    this.itemList[OakItemType.Exp_Share] = new OakItem(
      OakItemType.Exp_Share,
      "EXP Share"
    );
    this.itemList[OakItemType.Sprayduck] = new OakItem(
      OakItemType.Sprayduck,
      "Sprayduck"
    );
    this.itemList[OakItemType.Shiny_Charm] = new OakItem(
      OakItemType.Shiny_Charm,
      "Shiny Charm"
    );
    this.itemList[OakItemType.Magma_Stone] = new OakItem(
      OakItemType.Magma_Stone,
      "Magma Stone"
    );
    this.itemList[OakItemType.Cell_Battery] = new OakItem(
      OakItemType.Cell_Battery,
      "Cell Battery"
    );
    this.itemList[OakItemType.Squirtbottle] = new OakItem(
      OakItemType.Squirtbottle,
      "Squirtbottle"
    );
    this.itemList[OakItemType.Sprinklotad] = new OakItem(
      OakItemType.Sprinklotad,
      "Sprinklotad"
    );
    this.itemList[OakItemType.Explosive_Charge] = new OakItem(
      OakItemType.Explosive_Charge,
      "Explosive Charge"
    );
    this.itemList[OakItemType.Treasure_Scanner] = new OakItem(
