...
class Egg {
  ...
  constructor(
    ...
    this.partyPokemon = function () {
      return this.__partyPokemon;
    }.bind(this);
  ...
  __initPokemon() {
    ...
    if (this.pokemon != "MissingNo.") {
      ...
      this.pokemonType2 =
        dataPokemon.type2 === PokemonType.None
          ? dataPokemon.type1
          : dataPokemon.type2;
    } else {
    ...
    if (!this.isNone()) {
      this.__partyPokemon = App.game.party.getPokemon(
        PokemonHelper.getPokemonByName(this.pokemon).id
      );
    }
  }
}
